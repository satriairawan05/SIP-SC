...
@section('app')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('cuti.update',$cuti->cuti_id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <div class="row mb-3">
                                ...
                                @enderror"
                                        ...
                                        value="{{ old('cuti_jenis',$cuti->cuti_jenis) }}" name="cuti_jenis" required>
                                    @error('cuti_jenis')
                                ...
                                @enderror"
                                        ...
                                        value="{{ old('cuti_jumlah',$cuti->cuti_jumlah) }}" name="cuti_jumlah" required>
                                    @error('cuti_jumlah')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
