...
@section('app')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('surat_cuti.update',$surat->sc_id) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <select class="pic form-control form-control-sm" name="pic_id">
                                        @foreach ($pic as $d)
                                            @if (old('pic_id',$surat->pic_id) == $d->id)
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <select class="cuti form-control form-control-sm" name="cuti_id">
                                        @foreach ($cuti as $d)
                                            @if (old('cuti_id',$surat->cuti_id) == $d->cuti_id)
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="departemen form-control form-control-sm" name="departemen_id">
                                        @foreach ($departemen as $d)
                                            @if (old('departemen_id',$surat->departemen_id) == $d->departemen_id)
                            ...
                            <div class="row mb-3">
                                <div class="col-4">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="sc_tgl_ambil_start" value="{{ old('sc_tgl_ambil_start', $surat->sc_tgl_ambil_start) }}"
                                ...
                                <div class="col-4">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="sc_tgl_ambil_end" value="{{ old('sc_tgl_ambil_end',$surat->sc_tgl_ambil_end) }}" name="sc_tgl_ambil_end"
                                        required>
                                ...
                                <div class="col-4">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="sc_tgl_kembali" value="{{ old('sc_tgl_kembali',$surat->sc_tgl_kembali) }}" name="sc_tgl_kembali" required>
                            ...
                            <div class="row mb-3">
                                ...
                                @enderror" placeholder="Masukan Alamat Cuti"
                                        id="sc_alamat_cuti" value="{{ old('sc_alamat_cuti',$surat->sc_alamat_cuti) }}"
                                ...
                                @enderror" placeholder="Masukan Nomor HP yang dapat dihubungi"
                                        id="sc_no_hp" value="{{ old('sc_no_hp',$surat->sc_no_hp) }}"
